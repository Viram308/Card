...
public class MainActivity extends AppCompatActivity {
    ...
    ImageView myC1,myC2,myC3,oppC1,oppC2,oppC3;
    TextView  u0s, u1s, winners;
    ImageView u0photo,u1photo,gg;
    Button see;
    Button pack, blind, show;
    LinearLayout mi, csk,l1,l2;
    int restart = 0;
    ...
    void changeTurn() {
        ...
        if (turn == 0) {
            ...
            l1.setBackgroundResource(R.drawable.noborder);
            if (turn != user) {
            ...
            l2.setBackgroundResource(R.drawable.noborder);
    ...
    void createCards() {
        ...
        while (i < 2) {
            ...
            } else if (sagar == 3)//type4
            {
                ...
                int cg=card4;
                card4 = rand.nextInt(13) + 1;
                while (hash1[card4 - 1] == 1 && card4 != cg+1 && card4 != cg-1)
                    card4 = rand.nextInt(13) + 1;
                hash1[card4 - 1] = 1;
                temp = IntToMain(card4);
...
//Extract the data…
        ...
        oppC1 = findViewById(R.id.oppC1);
        myC2 = findViewById(R.id.myC2);
        oppC2 = findViewById(R.id.oppC2);
        myC3 = findViewById(R.id.myC3);
        oppC3 = findViewById(R.id.oppC3);
...
//Fire that second activity
                            ...
                            Handler h123=new Handler();
                            h123.postDelayed(ru,3000);
...
//Fire that second activity
                    ...
                    if (isshow.equals("1")) {
                        if (kkr != 1) {
                            ...
                            int resID = getResources().getIdentifier(pp0, "drawable",getPackageName());
                            myC1.setImageResource(resID );
                            resID = getResources().getIdentifier(pp1, "drawable",getPackageName());
                            myC2.setImageResource(resID );
                            resID = getResources().getIdentifier(pp2, "drawable",getPackageName());
                            myC3.setImageResource(resID );
                            resID = getResources().getIdentifier(b0, "drawable",getPackageName());
                            oppC1.setImageResource(resID );
                            resID = getResources().getIdentifier(b1, "drawable",getPackageName());
                            oppC2.setImageResource(resID );
                            resID = getResources().getIdentifier(b2, "drawable",getPackageName());
                            oppC3.setImageResource(resID );
                            if (srh == 0) {
                                srh = 1;
                                restart = 1;
                                ref.child("isblind0").setValue("1");
...
//Fire that second activity
        ...
        see.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (user == 0) {
                    String mc1 = null,mc2=null,mc3=null;
                    if(pp0.charAt(0)=='r' || pp0.charAt(0)=='b' )
                    {

                        mc1='a'+pp0.substring(0,pp0.length()-1);
                    }
                    if(pp1.charAt(0)=='r' || pp1.charAt(0)=='b' )
                    {
                        mc2='a'+pp1.substring(0,pp1.length()-1);
                    }
                    if(pp2.charAt(0)=='r' || pp2.charAt(0)=='b' )
                    {
                        mc3='a'+pp2.substring(0,pp2.length()-1);
                    }
                    if(pp0.charAt(0)=='R')
                    {
                        mc1='r'+pp0.substring(1,pp0.length()-1);
                    }
                    if(pp1.charAt(0)=='R')
                    {
                        mc2='r'+pp1.substring(1,pp1.length()-1);
                    }
                    if(pp2.charAt(0)=='R')
                    {
                        mc3='r'+pp2.substring(1,pp2.length()-1);
                    }
                    if(pp0.charAt(0)=='B')
                    {
                        mc1='b'+pp0.substring(1,pp0.length()-1);
                    }
                    if(pp1.charAt(0)=='B')
                    {
                        mc2='b'+pp1.substring(1,pp1.length()-1);
                    }
                    if(pp2.charAt(0)=='B')
                    {
                        mc3='b'+pp2.substring(1,pp2.length()-1);
                    }
                    int resID = getResources().getIdentifier(mc1, "drawable",getPackageName());
                    myC1.setImageResource(resID );
                    resID = getResources().getIdentifier(mc2, "drawable",getPackageName());
                    myC2.setImageResource(resID );
                    resID = getResources().getIdentifier(mc3, "drawable",getPackageName());
                    myC3.setImageResource(resID );
                    ref.child("issee0").setValue("1");
                    ref.child("isblind0").setValue("0");
                } else {
                    String oc1=null,oc2=null,oc3=null;
                    if(b0.charAt(0)=='r' || b0.charAt(0)=='b' )
                    {
                        oc1='a'+b0.substring(0,b0.length()-1);
                    }
                    if(b1.charAt(0)=='r' || b1.charAt(0)=='b' )
                    {
                        oc2='a'+b1.substring(0,b1.length()-1);
                    }
                    if(b2.charAt(0)=='r' || b2.charAt(0)=='b' )
                    {
                        oc3='a'+b2.substring(0,b2.length()-1);
                    }
                    if(b0.charAt(0)=='R')
                    {
                        oc1='r'+b0.substring(1,b0.length()-1);
                    }
                    if(b1.charAt(0)=='R')
                    {
                        oc2='r'+b1.substring(1,b1.length()-1);
                    }
                    if(b2.charAt(0)=='R')
                    {
                        oc3='r'+b2.substring(1,b2.length()-1);
                    }
                    if(b0.charAt(0)=='B')
                    {
                        oc1='b'+b0.substring(1,b0.length()-1);
                    }
                    if(b1.charAt(0)=='B')
                    {
                        oc2='b'+b1.substring(1,b1.length()-1);
                    }
                    if(b2.charAt(0)=='B')
                    {
                        oc3='b'+b2.substring(1,b2.length()-1);
                    }
                    int resID = getResources().getIdentifier(oc1, "drawable",getPackageName());
                    oppC1.setImageResource(resID );
                    resID = getResources().getIdentifier(oc2, "drawable",getPackageName());
                    oppC2.setImageResource(resID );
                    resID = getResources().getIdentifier(oc3, "drawable",getPackageName());
                    oppC3.setImageResource(resID );
